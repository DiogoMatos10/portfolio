    ...
    return (
        <div className="contact-container">
            ...
            <div className="links-icon">
                <abbr title="GitHub">
                    <Link to={'https://github.com/DiogoMatos10'} target="_blank" rel="noopener noreferrer" className="link-box">
                        <svg width="35" height="35" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="github-icon">
                        ...
                        <p className="link-description">{t("contact.gitHubDescription")}</p>
                    </Link>
                </abbr>
                <abbr title="Linkedin">
                ...
                <abbr title={t("contact.email")}>
                    <a href="mailto:diogo.matos.dev@outlook.com" rel="noopener noreferrer" className="link-box">
                        <svg width="40" height="40" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="email-icon">
                        ...
                        <p className="link-description">{t("contact.emailDescription")}</p>
                    </a>
                </abbr>
            </div>
        </div>
