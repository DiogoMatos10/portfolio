...
import avatarDark from "../../../public/images/Fundo Escuro/avatar@1xdark.png";
import avatarLight from "../../../public/images/Fundo Claro/avatar@1xlight.png";
    ...
    <div className="home-container">
      <div className="contentLeft">
        <TypeAnimation
          ...
          speed={50}
          repeat={0}
          className="titles after-effect"
          onComplete={() => {
            document.querySelector(".titles")?.classList.add("no-cursor");
          }}
        />
        <img
          className="avatar"
        ...
        <div className="links-icon">
          <abbr title="GitHub">
            <Link
              ...
              to={"https://github.com/DiogoMatos10"}
              target="_blank"
            >
              <svg
                width="35"
          ...
          <abbr title="Linkedin">
            <Link
              ...
              to={"https://www.linkedin.com/in/diogo-matos-72b387274/"}
              target="_blank"
            >
              <svg
                width="40"
          ...
          <abbr title="Instagram">
            <Link
              ...
              to={"https://www.instagram.com/dmatos_dev/"}
              target="_blank"
            >
              <svg
                width="40"
